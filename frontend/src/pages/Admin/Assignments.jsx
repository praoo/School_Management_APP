...
const Assignments = () => {
  ...
  const fetchAssignments = async () => {
    try {
      ...
      setAssignments(response.data.assignments || []); // Safely handle assignments data
    } catch (error) {
          ...
          <AssignmentList>
            {assignments.map((assignment, index) => (
              <AssignmentItem key={assignment.id || index}>
                ...
                {assignment.description || 'No description'}, {assignment.grade || 'No grade'}, {assignment.deadline || 'No deadline'}
              </AssignmentItem>
            ))}
          </AssignmentList>
        </AssignmentsContent>
